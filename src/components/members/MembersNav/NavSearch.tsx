...
export function NavSearch() {
  ...
  // Check if we're on the articles listing page (main members page)
  const isArticlesPage = pathname === '/members'
  ...
  const handleClear = useCallback(() => {
    setSearchValue('')
    // Always navigate to clean /members URL to clear search
