...
import { SeriesFilterSidebar } from './SeriesFilterSidebar'
...
interface MembersSeriesPageProps {
  series: SeriesWithFilterData[]
  filterOptions: SeriesFilterOptions
}

export function MembersSeriesPage({ series, filterOptions }: MembersSeriesPageProps) {
  ...
  const updateFiltersAndUrl = useCallback(
    (newFilters: SeriesFilterState) => {
      ...
      const newUrl = params.toString()
        ? `/members/series?${params.toString()}`
        : '/members/series'
