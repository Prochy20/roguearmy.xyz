...
import { BlogSeriesArticleCard } from './BlogSeriesArticleCard'
...
const meta = {
  title: 'Components/Blog/BlogSeriesArticleCard',
  component: BlogSeriesArticleCard,
...
} satisfies Meta<typeof BlogSeriesArticleCard>
