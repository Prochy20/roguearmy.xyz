...
const ACCENT_TEXT: Record<StaffAccent, string> = {
  ...
  dev: 'text-role-dev [text-shadow:0_0_24px_rgba(204,255,0,0.55)]',
  admin: 'text-role-admin [text-shadow:0_0_24px_rgba(255,0,102,0.55)]',
  mod: 'text-role-mod [text-shadow:0_0_24px_rgba(255,128,0,0.55)]',
}
