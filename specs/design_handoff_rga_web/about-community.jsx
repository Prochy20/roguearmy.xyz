  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>/</span>
        <span style={{ color: RGA.text2 }}>ABOUT</span>
        <span>/</span>
        <span style={{ color: RGA.text }}>THE_COMMUNITY</span>
        <span
          style={{
            flex: 1,
            maxWidth: 320,
      ...
      >
        // A community of grown-ups who still play.
      </div>
      ...
      >
        ...
        >
          A small, deliberately quiet community of <strong style={{ color: RGA.text }}>gamers 25 and up</strong>.
          We play hard, talk about it longer, and we kick out anyone who can't be kind about it.
          No clout. No grind. No kids in voice chat doing voice-cracks at 2am.
        </p>
        ...
        >
          ...
          <MetaRow label="Founded" value="Jan 2019" mono />
          <MetaRow label="Members" value="2,847" mono />
          <MetaRow label="Min age" value="25" mono />
          <MetaRow label="Mods" value="6 humans" />
          <MetaRow label="Cost" value="$0 / forever" />
          <MetaRow label="Region" value="Earth, mostly" />
        </div>
      </div>
...
Object.assign(window, { AboutCommunity });
